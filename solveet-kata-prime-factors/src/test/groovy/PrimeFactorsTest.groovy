...
class PrimeFactorsTest {
    ...
    /**
     * This number is isolated because it is a big prime number and it takes more than a 
     * minute to compute
     */
    @Test
    public void testBigPrimeNumber() {
        ...
        assert expected == primeFactors.generate(bigPrime)
    }
    
    /**
     * This number is isolated in this test because 2**100 doesn't fit in an int,
     * and the PrimeFactors.generate() method should change its interface to 
     * BigInteger. Too much changes given the method is good enough for this practice 
     */
    @Test
    public void testBigIntegerNumber() {
        ...
        assert expected == primeFactors.generate(bigInt)
    }
}